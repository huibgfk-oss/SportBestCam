...
android {
    ...
    defaultConfig {
        applicationId = "com.sportbestcam"
        minSdk = 24
        targetSdk = 36
...
// ./gradlew assembleDefaultProPlusRelease -PcustomAppName="Custom Name" - Pro+ custom build (standalone)
    ...
    // Dynamic APK output names: SportBestCam_<flavor>_v<versionName><suffix>-<abi>.apk
    ...
    applicationVariants.all {
        ...
        outputs.all {
            ...
            (this as com.android.build.gradle.internal.api.BaseVariantOutputImpl).outputFileName =
                "SportBestCam_${flavor}v${versionName}-${abiType}.apk"
        }
    }
