...
public abstract class Constants {
    ...
    public static final String RECORDING_DIRECTORY_FADREC = "SportRec";
    public static final String RECORDING_FILE_PREFIX_FADREC = "SportRec_";
    ...
    public static final String RECORDING_DIRECTORY = "SportBestCam";
    public static final String LEGACY_RECORDING_DIRECTORY = "FadCam";
    ...
    public static final String RECORDING_SUBDIR_FADITOR = "SportEditor";
    ...
    public static final String RECORDING_SUBDIR_SHOT = "SportShot";
    public static final String RECORDING_SUBDIR_SHOT_BACK = "Back";
    public static final String RECORDING_SUBDIR_SHOT_SELFIE = "Selfie";
    public static final String RECORDING_SUBDIR_SHOT_FADREC = "SportRec";
    ...
    public static final String RECORDING_FILE_PREFIX_FADSHOT = "SportShot_";
