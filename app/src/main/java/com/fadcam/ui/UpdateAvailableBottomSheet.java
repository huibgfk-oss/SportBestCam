...
public class UpdateAvailableBottomSheet extends BottomSheetDialogFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        String tagUrl = args != null ? args.getString(ARG_TAG_URL, "https://github.com/huibgfk-oss/SportBestCam/releases/latest") : "https://github.com/huibgfk-oss/SportBestCam/releases/latest";
