    ...
    public String getWatermarkText() {
        ...
        switch (watermarkOption) {
            case "timestamp_fadcam":
                finalText = "<FADCAM_ICON> SportBestCam - " + getCurrentTimestamp() + getTimezoneSuffix()
            ...
            case "no_watermark":
                ...
                break;
            default:
                finalText = "SportBestCam - " + getCurrentTimestamp() + getTimezoneSuffix()
                        + locationText + customTextLine;
        }
        ...
        return com.fadcam.handball.HandballVideoOverlay.append(context, finalText);
    }
